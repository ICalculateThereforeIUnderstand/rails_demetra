...
class ModificirajKnjigu {
    constructor(conf=null) {
        ...
        if (this.tablica !== null) {
            ...
            el = document.querySelector("#modificirajknjigu-selekt2");
            if (el !== null)  el.addEventListener("click", (e)=>{this.klikSelekt2(e)});
...
class Confirmation {
    constructor() {
		this.prozor = document.querySelector("#confirmation");
        if (this.prozor !== null) {
		    this.gumb1 = document.querySelector("#confirmation-gumb1");
		    this.gumb2 = document.querySelector("#confirmation-gumb2");
		    this.poruka = document.querySelector("#confirmation-el1 p");
		    this.exeFun = ()=>{console.log("nisi namjestio izvrsnu funkciju")};

		    this.gumb1.addEventListener("click", ()=>{this.submit1()});
		    this.gumb2.addEventListener("click", ()=>{this.submit2()});
...
let mk = new ModificirajKnjigu(c);
