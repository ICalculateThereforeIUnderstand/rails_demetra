class ManagersController < ApplicationController
    ...
    def modificiraj_knjigu
        ...
        @kolicine =  Skladista.connection.select_all(Skladista.sanitize_sql_for_conditions(["SELECT skladista.skladiste, adrese.adresa, veze1.kolicina FROM veze1 INNER JOIN adrese ON veze1.kodadrese = adrese.id INNER JOIN skladista ON skladista.id = adrese.kodskladista WHERE veze1.kodknjige = ?", idKnjige]));
